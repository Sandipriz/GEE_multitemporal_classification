...
drive_auth()
# Set the Python environment explicitly
use_python("C:/Users/srijal2023/AppData/Local/r-miniconda/envs/r-reticulate/python.exe")
...
ee_Authenticate()
ee_Initialize("document.sandip55@gmail.com", drive = TRUE)
#ee_Initialize(user = 'sandip.rijal55@gmail.com', drive = TRUE)
...
#ee_Authenticate()
#ee_Initialize(user="sandip.rijal55@gmail.com", auth_quiet = TRUE)
...
samples1 <- ee$FeatureCollection('projects/ee-barbarasilvaipam/assets/collection8/sample/points/samplePoints_v2')

ee_print(samples)


# Convert the Earth Engine Feature Collection to an R spatial object
#samples_df <- ee_as_sf(samples, maxFeatures = 500000)

#library(leaflet)
#library(tidyverse)

# Extract coordinates from the geometry column
#coordinates <- st_coordinates(samples_df$geometry)
...
#leaflet() %>%
#  addTiles() %>%
#  addCircleMarkers(lng = coordinates[, "X"], lat = coordinates[, "Y"], radius=0.2)
