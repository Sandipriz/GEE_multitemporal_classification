...
## define output asset
output_asset <- 'projects/cerrado123/assets/5_output/'

## define years to be classified
years <- unique(mosaic$aggregate_array('year')$getInfo())

## get mosaic rules
rules <- read.csv('C:/Users/srijal2023/Desktop/_aux/mosaic_rules.csv')
...
training_dir <- 'projects/cerrado123/assets/04_outputs'
...
param_bands <- read.csv('C:/Users/srijal2023/Desktop/_aux/bands.csv', sep= '')
param_rf <- read.csv('C:/Users/srijal2023/Desktop/_aux//rf.csv', sep= '')
